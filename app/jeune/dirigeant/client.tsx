    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3">
        ...
        <div className="text-center flex flex-col items-center gap-1.5">
          <p className="text-xs font-bold uppercase tracking-widest text-amber-600 bg-amber-50 px-2 py-1 rounded-md">Année {year}</p>
          <input
            className="text-center text-sm font-semibold text-slate-800 bg-transparent border-b border-slate-200 hover:border-amber-300 focus:border-amber-500 focus:outline-none transition-colors px-2 py-1 max-w-[250px]"
            value={weekTitle}
      ...
      <div className="sticky bottom-0 -mx-4 mt-2 border-t border-slate-200/60 bg-white/80 px-4 py-4 backdrop-blur-xl shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        <button
          ...
          className="btn-primary w-full py-3 text-base bg-amber-600 hover:bg-amber-700 shadow-amber-500/20"
        >
          {status === "saving" ? (
